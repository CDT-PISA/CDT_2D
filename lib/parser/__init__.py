...
def define_parser(launcher_path, version):
    ...
    run_sub.add_argument('-q', '--queue', default='debug',
                         ...
                         help=msgs.queue)
    run_sub.add_argument('--arch', default='skl', choices=['skl', 'knl'],
                         help=msgs.queue)
    ...
    pre_sub.add_argument('-s', '--save_path', type=str,
                         default=None, help=msgs.save_path)
    ...
    data_types = ['v', 'volumes', 'p', 'profiles', 'pf', 'profiles-fit',
                  ...
                  't', 'torelons', 'tf', 'torelons-fit', 'tf2', 'torelons-fit2']
